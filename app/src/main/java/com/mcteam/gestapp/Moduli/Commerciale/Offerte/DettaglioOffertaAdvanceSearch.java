...
public class DettaglioOffertaAdvanceSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dettaglio_offerta_advance_search);
        ...
        mOffRecyclerView = (RecyclerView) findViewById(R.id.dettaglio_offerta_ricerca_avanzata_recycler);
        mOffRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mOffRecyclerView.setAdapter(mOffAdapter);

        mVersione = (EditText) findViewById(R.id.dettaglio_offerta_ricerca_avanzata_versione);

        mDataOfferta = (EditText) findViewById(R.id.dettaglio_offerta_ricerca_avanzata_data);
...
//http://androidopentutorials.com/android-datepickerdialog-on-edittext-click-event/
        ...
        mPresentata = (RadioButton) findViewById(R.id.dettaglio_offerta_presentata_si);
        mNonPresentata = (RadioButton) findViewById(R.id.dettaglio_offerta_presentata_no);
        mResultStatus = (TextView) findViewById(R.id.dettaglio_offerta_ricerca_avanzata_status);
        cercaButton = (ImageButton) findViewById(R.id.dettaglio_offerta_ricerca_avanzata_cerca_button);
        mInputs = (LinearLayout) findViewById(R.id.dettaglio_offerta_ricerca_avanzata_inputs);
